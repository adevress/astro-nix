let
  ...
  astro_pkgs =  rec {
    ...
    wsclean = pkgs.callPackage ./wsclean/default.nix { inherit aocommon radler schaapcommon idg; ska-sdp-func = null; };
...
in 
{ upstream_pkgs ? pkgs }:  pkgs // astro_pkgs // py_astro_pkgs
